...
export default function LandingPage({
  ...
  return (
    <main className="min-h-screen px-6 py-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 animate-fade-in">
        <header className="space-y-3">
          ...
          <p className="max-w-2xl text-base text-zinc-400 md:text-lg">
            A quiet place for the words you never send. Write to yourself, keep
            the key, return when the world feels too loud.
          </p>
        </header>
