      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 animate-fade-in">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.3fr_1fr]">
          <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-6">
            ...
            <div className="space-y-3">
              {filteredEntries.length === 0 ? (
                <p className="text-sm text-zinc-500">{t("admin_no_results")}</p>
              ) : (
          ...
          <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-6">
            ...
            <p className="mb-4 text-sm text-zinc-400">{t("banned_desc")}</p>
            <form className="space-y-3" onSubmit={handleAddWord}>
              ...
              />
              {bannedError ? (
                <p className="text-sm text-rose-400">{t(bannedError)}</p>
              ) : null}
              <button
                type="submit"
            ...
            <div className="mt-6 space-y-2">
              {bannedWords.length === 0 ? (
                <p className="text-sm text-zinc-500">{t("banned_empty")}</p>
              ) : (
